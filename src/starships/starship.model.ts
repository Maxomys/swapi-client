...
export class Starship extends BaseStarWarsModel {
  ...
  @Field(() => String, {
    description: "The model or official name of this starship, such as 'DS-1 Orbital Battle Station'.",
  })
  model: string;
  ...
  @Field(() => String, {
    description: "The maximum speed of this starship in the atmosphere. 'N/A' if incapable of atmospheric flight.",
  })
